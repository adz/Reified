...
type JsonCodecBenchmarks() =
    ...
    member _.ReifiedSerialize() = Json.serialize codec CodecModel.sample
    ...
    [<Benchmark(Description = "Reified Json.deserialize")>]
    member _.ReifiedDeserialize() = Json.deserialize codec json

    [<Benchmark(Description = "Reified Json.deserializeBytes")>]
    member _.ReifiedDeserializeBytes() = Json.deserializeBytes codec jsonBytes
...
type BoundaryParseBenchmarks() =
    ...
    [<Benchmark(Baseline = true, Description = "Reified Json.deserialize (trusted lane)")>]
