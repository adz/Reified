...
→ [Modelling with Schema](/modelling/quickstart.html) · [Input sources](/modelling/input-sources.html)
...
the first place, see [Trusted construction](/modelling/trusted-construction.html).

→ [Trusted construction](/modelling/trusted-construction.html)
...
→ [HTTP servers and OpenAPI](/http-contracts/index.html)
...
→ [Schema overview](/modelling/overview.html)
...
→ [Contracts and versioning](/http-contracts/contracts.html)
...
→ [Data](/testing/index.html) · [Building test cases](/testing/how-to-build-test-cases.html)
