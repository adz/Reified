...
[`mustSupply`/`mayOmit`](/schema/index.html).
...
[Working with violations](/constraints/violations.html) for rendering, domain error mapping, groups, and programmatic inspection.
