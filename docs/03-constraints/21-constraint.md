...
- [Refined values](/refined/domain-values.html) use a constraint to construct invariant-carrying domain types.
- [Schema](/schema/refined-values.html) adds structured input, paths, accumulation, and wire interpreters.
...
[How it compares](/comparisons/dataannotations-fluentvalidation-comparison.html).

Otherwise take [ConstraintDSL](/constraints/dsl.html) for the full vocabulary and how to write a rule module,
