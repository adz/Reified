...
Look keys up in [the catalogue](/constraints/localization/catalogue.html).
...
and check what is missing with [Adding a language](/constraints/adding-a-language.html).
