...
Start with [Result](./), then read [Collecting every error](/result-handling/collecting-errors.html).

For compact prompt context, load [`/result-handling/llms.txt`](/result-handling/llms.txt).
