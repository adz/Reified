...
Everything the [Localization](/validating-values/localization/index.html) page describes about candidate order, contextual fallback,
...
[Adding a language](/validating-values/adding-a-language.html). Since the same catalogue drives both targets, one generated bundle
...
beyond the resources themselves. See [AOT, trimming, and Fable](/notes/aot-trimming-fable.html) for
