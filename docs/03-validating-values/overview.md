...
[`mustSupply`/`mayOmit`](/modelling/index.html).
...
[Working with violations](/validating-values/violations.html) for rendering, domain error mapping, groups, and programmatic inspection.
