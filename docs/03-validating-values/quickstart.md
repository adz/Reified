...
[`Reified.Result`](/validating-values/result/index.html), but FsToolkit.ErrorHandling or your own helpers work identically:
...
it. See [Working with violations](/validating-values/violations.html) for grouped failures, inspection, and localization.
...
[Reified.Schema](/modelling/index.html) is the structured-boundary layer. A `Schema<'model>` declares fields and
