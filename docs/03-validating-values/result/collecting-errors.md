...
See [the Schema quickstart](/modelling/quickstart.html).
...
[`Result.traverseAll` and `Result.sequenceAll`](/validating-values/result/collections.html#traverseall-and-sequenceall), which run every mapping
