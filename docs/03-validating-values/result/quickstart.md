...
it can depend on the earlier results. See [Collecting every error](/validating-values/result/collecting-errors.html) for the exact boundary.
...
first place belongs to the [Values](/validating-values/index.html) packages, and path-aware accumulated diagnostics over a
whole structured input belong to [Reified.Schema](/modelling/index.html).
...
- [Transforming values](/validating-values/result/transforming.html)
- [Handling errors](/validating-values/result/handling-errors.html)
- [The result computation expression](/validating-values/result/result-ce.html)
- [Collecting every error](/validating-values/result/collecting-errors.html)
- [Comparison with FsToolkit.ErrorHandling](/how-it-compares/fstoolkit-comparison.html)
