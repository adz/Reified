...
group. See [Localization](/validating-values/localization/index.html) for rendering, with [context and fallback](/validating-values/localization/context-and-fallback.html),
[advanced rendering](/validating-values/localization/advanced-rendering.html) for groups and plurals, and
[the key catalogue](/validating-values/localization/catalogue.html). [Adding a language](/validating-values/adding-a-language.html) covers generating a new
translation.
