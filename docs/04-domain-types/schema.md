...
If Schema is new to you, start with [the Schema quickstart](/modelling/quickstart.html) for fields,
record construction, and path-aware diagnostics. Then read [Refined Values in Schema](/modelling/refined-values.html) for canonical field schemas, raw-value constraints, explicit refinement, and
...
[Refined Values in Schema](/modelling/refined-values.html).
