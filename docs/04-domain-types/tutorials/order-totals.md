...
[why there are no refined numbers](/domain-types/catalog.html#why-there-are-no-refined-numbers).
...
- [Built-in Refined Values](/domain-types/catalog.html) — what each type is closed under.
- [Customer Id](/domain-types/tutorials/customer-id.html) — define a refined type of your own, and give it a schema.
- [Compose Parse and Refinement](/domain-types/composition.html) — mapping failures to application errors.
