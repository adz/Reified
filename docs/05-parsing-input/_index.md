...
[`Schema`](/modelling/quickstart.html) parses each field, accumulates every failure, and reports the
...
See [Refined values](/domain-types/index.html) for the refinement model, and the
