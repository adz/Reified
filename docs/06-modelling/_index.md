...
<a class="docs-home-cta" href="/modelling/quickstart.html">Get started &gt;</a>
<a class="docs-chip" href="/modelling/quickstart.html">Quickstart</a>
<a class="docs-chip" href="/modelling/overview-examples.html">Overview examples</a>
<a class="docs-chip" href="/modelling/reference-apps.html">Reference apps walkthrough</a>
</div>
</div>
...
| --- | --- | --- |
| `Reified.Schema` | Model schemas, parsing, checking, accumulated errors, inspection, and JSON Schema generation through its `JsonSchema` module | [Reified.Schema](/modelling/overview.html) |
| `Reified.Schema.Json` | Compiled JSON codecs | [JSON Codec](/json/index.html) |
| `Reified.Schema.Contracts.Build` | Build-time schema derivation from F# records | [Derived Schemas](/modelling/derivation/index.html) |
| `Reified.Schema.Http` | HTTP-neutral request and response contracts | [HTTP Servers](/http-contracts/index.html) |

`JsonSchema` is a module inside `Reified.Schema`, not a package of its own — see the
[JSON Schema reference](/api.html).
...
[Testing patterns](/testing/testing-schema-guarantees.html).
...
without checking it again — see [Trusted Construction](/modelling/trusted-construction.html).

## Related Products

[Values](/validating-values/index.html) provides the reusable checks and refined values that Schema
...
See [Reified.Schema](/modelling/overview.html) for the core package's mental model, installation, and full guide list.
