...
[Schema DSL](/modelling/dsl.html) as a hand-written declaration and therefore works with parsing, inspection, JSON codecs,
JSON Schema, NativeAOT, trimming, and Fable.

## Guides

- [Set up build generation](/modelling/derivation/msbuild.html) — package reference, generated-file modes, and MSBuild properties.
- [Attributes](/modelling/derivation/attributes.html) — every supported attribute and its Schema DSL equivalent.
- [How inference works](/modelling/derivation/inference.html) — records, field types, names, constructors, unions, and diagnostics.
...
[Separate Wire and Domain Models](/modelling/patterns/wire-and-domain-models.html).
