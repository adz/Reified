...
[`ReifiedSchemaNaming`](/modelling/derivation/msbuild.html#msbuild-properties) to `snake` or `verbatim` for the whole project. Use
...
[attribute table](/modelling/derivation/attributes.html#field-attributes). Constraints remain executable and inspectable, so parsing,
...
The generated schema follows the handwritten [union schema rules](/modelling/union-schemas.html).
...
[Versioned Contracts](/http-contracts/contracts.html).
