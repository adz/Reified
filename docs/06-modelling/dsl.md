...
The typed vocabulary in `Reified.SchemaDSL` covers every [interpreted](/validating-values/constraints.html)
...
See [Derivation Attributes](/modelling/derivation/attributes.html) for the complete attribute mapping.
...
[Refined value schemas](/modelling/refined-values.html) works this through end to end, including writing the refinement itself.
