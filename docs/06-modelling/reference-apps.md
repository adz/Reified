...
1. [`Reified.ReferenceApp.Intro`](/validating-values/reference-app.html) — plain `Result`, checks,
...
See [Versioned Contracts](/http-contracts/contracts.html) for the full attribute vocabulary, the
...
([HTTP Servers](/http-contracts/index.html)).
