...
[Reified.Refinements](/domain-types/index.html) works this way — `NonBlankString`,
...
constraints use the same executable metadata defined by [Constraints](/validating-values/constraints.html).
...
[Interpreted and opaque](/validating-values/constraints.html) for the trade.
...
See [Define Refined Types](/domain-types/domain-values.html) for domain-side definitions.
