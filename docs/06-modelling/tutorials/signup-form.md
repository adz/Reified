...
smart constructor. [Construction Guarantees](/modelling/trusted-construction.html) covers the full division.

## Next

- [Nested Models And Collections](/modelling/tutorials/nested-and-collections.html) for models inside models.
- [Redisplay And Field Errors](/modelling/redisplay-and-field-errors.html) for the full redisplay guide.
- [Construction Guarantees](/modelling/trusted-construction.html) for which claims need a private type rather than a schema.
