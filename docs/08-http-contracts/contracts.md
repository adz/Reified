...
Schema derivation is documented separately. Start with [Derived Schemas](/modelling/derivation/index.html) to generate schemas from
...
See [Schema Inference](/modelling/derivation/inference.html#version-series-inference) for grouping rules and
[Build Generation](/modelling/derivation/msbuild.html) for setup.
