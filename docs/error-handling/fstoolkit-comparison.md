...
Axial separates these concerns by role: [Result]({{< relref "/error-handling/reference/result/" >}}) helpers
for standard fail-fast values, [Validation]({{< relref "/error-handling/reference/error-handling/" >}}) for
...
[Refined]({{< relref "/error-handling/reference/refined/" >}}) cover reusable constraints and values whose
...
| `asyncResult { }` | `flow {}` |
| `taskResult { }` | `flow {}` |
| [Validation]({{< relref "/error-handling/reference/error-handling/" >}}) helpers | [Validation]({{< relref "/error-handling/reference/error-handling/" >}}) and [`validate {}`]({{< relref "/error-handling/reference/error-handling/builders-validate.md" >}}) |
...
independent validation that should report multiple errors, [`Validation`]({{< relref "/error-handling/reference/error-handling/" >}}) and
[`validate {}`]({{< relref "/error-handling/reference/error-handling/builders-validate.md" >}}) provide that alternative.
