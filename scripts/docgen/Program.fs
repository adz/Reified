...
let pageSpecs = [
    ...
    }
    {
        ...
        Intro = "This page shows the `Check` surface for reusable, path-free value constraints. `Check.*` helpers return `Result<unit, CheckFailure list>` and can be composed with `Check.all`, `Check.any`, `Check.not`, and `Check.mapFailure`. Use `Predicate.*` helpers when a local branch needs a raw boolean, and use `Result.require` or `Result.guard` when a `Check<'value>` should become a fail-fast result that preserves the checked value."
        SymbolIds = [
            "Core types", ["T:Axial.ErrorHandling.Check`1"; "T:Axial.ErrorHandling.CheckFailure"; "T:Axial.ErrorHandling.CheckLengthExpectation"; "T:Axial.ErrorHandling.CheckRangeExpectation"; "T:Axial.ErrorHandling.CheckCountExpectation"; "T:Axial.ErrorHandling.CheckEqualityExpectation"]
            ...
            "Option and result predicates", ["M:Axial.ErrorHandling.PredicateModule.Option.isSome"; "M:Axial.ErrorHandling.PredicateModule.Option.isNone"; "M:Axial.ErrorHandling.PredicateModule.Option.present"; "M:Axial.ErrorHandling.PredicateModule.Option.empty"; "M:Axial.ErrorHandling.PredicateModule.Option.notEmpty"; "M:Axial.ErrorHandling.PredicateModule.ValueOption.isSome"; "M:Axial.ErrorHandling.PredicateModule.ValueOption.isNone"; "M:Axial.ErrorHandling.PredicateModule.ValueOption.present"; "M:Axial.ErrorHandling.PredicateModule.ValueOption.empty"; "M:Axial.ErrorHandling.PredicateModule.ValueOption.notEmpty"; "M:Axial.ErrorHandling.PredicateModule.Result.isOk"; "M:Axial.ErrorHandling.PredicateModule.Result.isError"]
            "Presence predicates", ["M:Axial.ErrorHandling.PredicateModule.Nullable.hasValue"; "M:Axial.ErrorHandling.PredicateModule.Nullable.hasNoValue"; "M:Axial.ErrorHandling.PredicateModule.Nullable.present"; "M:Axial.ErrorHandling.PredicateModule.Nullable.empty"; "M:Axial.ErrorHandling.PredicateModule.Nullable.notEmpty"; "M:Axial.ErrorHandling.PredicateModule.Reference.notNull"; "M:Axial.ErrorHandling.PredicateModule.Reference.isNull"]
            "String predicates", ["M:Axial.ErrorHandling.PredicateModule.String.isEmpty"; "M:Axial.ErrorHandling.PredicateModule.String.isNotEmpty"; "M:Axial.ErrorHandling.PredicateModule.String.isBlank"; "M:Axial.ErrorHandling.PredicateModule.String.isNotBlank"; "M:Axial.ErrorHandling.PredicateModule.String.hasMinLength"; "M:Axial.ErrorHandling.PredicateModule.String.hasMaxLength"; "M:Axial.ErrorHandling.PredicateModule.String.hasLength"; "M:Axial.ErrorHandling.PredicateModule.String.matches"; "M:Axial.ErrorHandling.PredicateModule.String.isEmail"; "M:Axial.ErrorHandling.PredicateModule.String.isNumeric"; "M:Axial.ErrorHandling.PredicateModule.String.isAlphaNumeric"]
            "Sequence predicates", ["M:Axial.ErrorHandling.PredicateModule.Seq.isEmpty"; "M:Axial.ErrorHandling.PredicateModule.Seq.isNotEmpty"; "M:Axial.ErrorHandling.PredicateModule.Seq.contains"; "M:Axial.ErrorHandling.PredicateModule.Seq.hasCount"; "M:Axial.ErrorHandling.PredicateModule.Seq.isSingle"; "M:Axial.ErrorHandling.PredicateModule.Seq.atMostOne"; "M:Axial.ErrorHandling.PredicateModule.Seq.atLeastOne"; "M:Axial.ErrorHandling.PredicateModule.Seq.moreThanOne"; "M:Axial.ErrorHandling.PredicateModule.Seq.hasDuplicates"; "M:Axial.ErrorHandling.PredicateModule.Seq.isDistinct"]
            "Comparison predicates", ["M:Axial.ErrorHandling.PredicateModule.Compare.greaterThan"; "M:Axial.ErrorHandling.PredicateModule.Compare.lessThan"; "M:Axial.ErrorHandling.PredicateModule.Compare.atLeast"; "M:Axial.ErrorHandling.PredicateModule.Compare.atMost"; "M:Axial.ErrorHandling.PredicateModule.Compare.between"; "M:Axial.ErrorHandling.PredicateModule.Compare.positive"; "M:Axial.ErrorHandling.PredicateModule.Compare.nonNegative"; "M:Axial.ErrorHandling.PredicateModule.Compare.negative"; "M:Axial.ErrorHandling.PredicateModule.Compare.nonPositive"]
        ]
        Alias = None
    }
    {
    ...
    }
    {
        ...
        Intro = "This page shows Axial's fail-fast helpers over the standard F# `Result<'value, 'error>` type. Use `Result.require` when a `Check<'value>` should return `Result<unit, CheckFailure list>`, and use `Result.guard` or named guards such as `Result.notBlank` when a check should keep the original value. Extraction helpers such as `Result.someOr` change the success shape, while sequence helpers such as `Result.single` return focused diagnostics. The `result { }` builder sequences ordinary fail-fast `Result` workflows."
        SymbolIds = [
            "Structured errors", ["T:Axial.ErrorHandling.CardinalityFailure"; "T:Axial.ErrorHandling.CheckFailure"]
