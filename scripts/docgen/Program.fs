...
let pageSpecs = [
    ...
    }
    {
        ...
        SymbolIds = [
            "Core types", ["T:Axial.Check.Check`1"; "T:Axial.Check.Constraint`1"; "T:Axial.Check.ConstraintMetadata"; "T:Axial.Check.ConstraintArgument"; "T:Axial.Check.CheckFailure"; "T:Axial.Check.CheckLengthExpectation"; "T:Axial.Check.CheckRangeExpectation"; "T:Axial.Check.CheckCountExpectation"]
