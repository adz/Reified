...
let pageSpecs = [
    ...
    }
    {
        ...
        SymbolIds = [
            ...
            "Extraction helpers", ["M:FsFlow.Check.takeSome"; "M:FsFlow.Check.takeValueSome"; "M:FsFlow.Check.takeHasValue"; "M:FsFlow.Check.takeOk"; "M:FsFlow.Check.takeError"; "M:FsFlow.Check.takeHead"; "M:FsFlow.Check.takeSingle"; "M:FsFlow.Check.takeAtMostOne"]
