...
let pageSpecs = [
    {
        ...
        SymbolIds = [
            "Core types", ["T:Reified.Schema`1"; "T:Reified.Field`2"; "T:Reified.UnionCase`1"]
            "Catalog", ["P:Reified.Schema.text"; "P:Reified.Schema.int"; "P:Reified.Schema.decimal"; "P:Reified.Schema.bool"; "P:Reified.Schema.dateTime"; "P:Reified.Schema.guid"; "M:Reified.Schema.list"; "M:Reified.Schema.option"; "M:Reified.Schema.constrain"; "M:Reified.Schema.constrainAll"; "M:Reified.Schema.mustSupply"; "M:Reified.Schema.mayOmit"; "M:Reified.Schema.refine"; "M:Reified.Schema.validate"; "M:Reified.Schema.union"; "M:Reified.UnionCase.create"; "T:Reified.Supply"]
            "Record builder", ["P:Reified.SchemaDSL.schema"; "M:Reified.SchemaDSL.field"; "M:Reified.SchemaDSL.construct"; "M:Reified.SchemaDSL.constructResult"]
            "Inspection", ["T:Reified.SchemaShape"; "T:Reified.SchemaDescription"; "T:Reified.FieldDescription"; "T:Reified.ModelDescription"; "T:Reified.UnionDescription"; "T:Reified.UnionCaseDescription"; "M:Reified.Inspect.model"; "M:Reified.Inspect.schema"; "M:Reified.Inspect.field"]
            "JSON Schema generation", ["M:Reified.JsonSchema.generate"; "M:Reified.JsonSchema.generateValue"]
    ...
    }
    {
        ...
        SymbolIds = [
            ...
            "Input parsing", ["M:Reified.Schema.parse"; "M:Reified.Schema.parseRetainingInput"; "M:Reified.Schema.parseWith"; "T:Reified.SchemaParseOptions"; "T:Reified.RetainedParseResult`1"; "M:Reified.RetainedParseResultModule.create"; "M:Reified.RetainedParseResultModule.renderErrors"]
            "Errors", ["T:Reified.SchemaError"; "T:Reified.SchemaPath"; "M:Reified.SchemaPath.root"; "M:Reified.SchemaPath.key"; "M:Reified.SchemaPath.index"; "M:Reified.SchemaPath.append"; "M:Reified.SchemaPath.format"; "M:Reified.SchemaPath.fold"; "T:Reified.SchemaIssue"; "T:Reified.SchemaErrors"; "M:Reified.SchemaErrors.toList"; "M:Reified.SchemaErrors.count"; "M:Reified.SchemaErrors.isEmpty"; "M:Reified.SchemaErrors.toString"; "M:Reified.SchemaErrors.messages"; "M:Reified.SchemaErrors.fullMessages"; "M:Reified.SchemaErrors.toStringWith"; "T:Reified.SchemaMessages"; "P:Reified.SchemaMessages.keys"; "P:Reified.SchemaMessages.arguments"; "P:Reified.SchemaMessages.english"]
            "Refined catalog schemas", ["P:Reified.RefinedSchemas.nonBlankString"; "P:Reified.RefinedSchemas.finiteFloat"; "P:Reified.RefinedSchemas.unitInterval"; "M:Reified.RefinedSchemas.nonEmptyList"; "M:Reified.RefinedSchemas.nonEmptyArray"; "M:Reified.RefinedSchemas.distinctList"; "M:Reified.RefinedSchemas.interval"; "P:Reified.RefinedSchemas.dateRange"; "M:Reified.RefinedSchemas.bounded"]
            "Existing values", ["M:Reified.Schema.check"]
        ]
        Alias = None
    }
    {
        ...
        SymbolIds = [
            ...
            "Literal syntax", ["T:Reified.DataField"; "M:Reified.DataModule.assoc"; "M:Reified.DataModule.optionalAssoc"; "M:Reified.DataModule.data"; "M:Reified.DataModule.number"; "M:Reified.DataModule.fields"; "M:Reified.DataDSL.data"; "M:Reified.DataDSL.op_EqualsGreater"; "M:Reified.DataDSL.op_QmarkEqualsGreater"; "P:Reified.DataDSL.nil"; "M:Reified.DataDSL.num"; "M:Reified.DataDSL.fields"]
            "Edits", ["T:Reified.DataEdit"; "T:Reified.DataPatchFailure"; "T:Reified.DataPatchException"; "M:Reified.DataEditModule.set"; "M:Reified.DataEditModule.replace"; "M:Reified.DataEditModule.remove"; "M:Reified.DataEditModule.append"; "M:Reified.DataEditModule.prepend"; "M:Reified.DataEditModule.insert"; "M:Reified.DataEditModule.rename"; "M:Reified.DataEditModule.update"; "M:Reified.DataModule.applyEdit"; "M:Reified.DataModule.patch"; "M:Reified.DataModule.set"; "M:Reified.DataModule.replace"; "M:Reified.DataModule.remove"; "M:Reified.DataModule.append"; "M:Reified.DataModule.prepend"; "M:Reified.DataModule.insert"; "M:Reified.DataModule.rename"; "M:Reified.DataModule.update"; "M:Reified.DataDSL.set"; "M:Reified.DataDSL.replace"; "M:Reified.DataDSL.remove"; "M:Reified.DataDSL.append"; "M:Reified.DataDSL.prepend"; "M:Reified.DataDSL.insert"; "M:Reified.DataDSL.rename"; "M:Reified.DataDSL.update"; "M:Reified.DataModule.tryPatch"]
            "Cases", ["T:Reified.DataVariation"; "T:Reified.DataCase"; "T:Reified.DataDimension"; "M:Reified.DataDSL.variant"; "M:Reified.DataDSL.variants"; "M:Reified.DataDSL.dimension"; "M:Reified.DataDSL.matrix"]
            "Comparison and matching", ["T:Reified.DataDifference"; "T:Reified.DataDifferenceCause"; "T:Reified.DataPattern"; "T:Reified.DataExpectation"; "T:Reified.DataMismatch"; "T:Reified.DataMatchException"; "M:Reified.DataModule.diff"; "M:Reified.DataModule.compare"; "M:Reified.DataModule.tryMatch"; "M:Reified.DataDSL.at"; "M:Reified.DataDSL.absent"; "M:Reified.DataDSL.matching"; "M:Reified.DataDSL.exactly"; "M:Reified.DataDSL.containing"; "M:Reified.DataDSL.containingItems"; "M:Reified.DataDSL.inOrder"; "M:Reified.DataDSL.allItems"; "M:Reified.DataDSL.someItem"; "P:Reified.DataDSL.any"; "P:Reified.DataDSL.anyText"; "P:Reified.DataDSL.anyNumber"; "M:Reified.DataDSL.oneOf"; "M:Reified.DataDSL.satisfying"]
    ...
    }
    {
        ...
        SymbolIds = [
            "Core types", ["T:Reified.Constraint`1"; "T:Reified.Violation"; "T:Reified.AtomicViolation"; "T:Reified.ConstraintDescription"; "T:Reified.ConstraintExpression"; "T:Reified.ConstraintAtom"; "T:Reified.OpaqueConstraint"; "T:Reified.ConstraintValue"]
            "Expectations", ["T:Reified.Presence"; "T:Reified.Cardinality"; "T:Reified.RelationOperator"; "T:Reified.Relation"; "T:Reified.Membership"; "T:Reified.Format"; "T:Reified.Number"; "T:Reified.UnsupportedOperation"]
            "Execution", ["M:Reified.ConstraintModule.test"; "M:Reified.ConstraintModule.check"; "M:Reified.ConstraintModule.guard"; "M:Reified.ConstraintModule.inspect"]
            "Composition", ["M:Reified.ConstraintModule.all"; "M:Reified.ConstraintModule.any"; "M:Reified.ConstraintModule.optional"; "M:Reified.ConstraintModule.notWith"; "M:Reified.ConstraintModule.custom"; "M:Reified.ConstraintModule.customLocalized"; "M:Reified.ConstraintModule.customLocalizedWith"; "M:Reified.ConstraintModule.customWith"; "M:Reified.ConstraintModule.contramap"; "M:Reified.ConstraintModule.describe"]
            "Presence and size", ["M:Reified.ConstraintModule.present"; "M:Reified.ConstraintModule.blank"; "M:Reified.ConstraintModule.length"; "M:Reified.ConstraintModule.minLength"; "M:Reified.ConstraintModule.maxLength"; "M:Reified.ConstraintModule.lengthBetween"]
            "Text formats", ["M:Reified.ConstraintModule.email"; "M:Reified.ConstraintModule.trimmed"; "M:Reified.ConstraintModule.numeric"; "M:Reified.ConstraintModule.alphanumeric"; "M:Reified.ConstraintModule.pattern"]
            "Relations and membership", ["M:Reified.ConstraintModule.equalTo"; "M:Reified.ConstraintModule.notEqualTo"; "M:Reified.ConstraintModule.greaterThan"; "M:Reified.ConstraintModule.lessThan"; "M:Reified.ConstraintModule.atLeast"; "M:Reified.ConstraintModule.atMost"; "M:Reified.ConstraintModule.between"; "M:Reified.ConstraintModule.oneOf"; "M:Reified.ConstraintModule.contains"; "M:Reified.ConstraintModule.distinct"]
            "Numeric properties", ["M:Reified.ConstraintModule.multipleOf"; "M:Reified.ConstraintModule.finite"; "M:Reified.ConstraintModule.finite32"]
            "Messages", ["T:Reified.MessageTree"; "T:Reified.MessageLeaf"; "T:Reified.MessageDescriptor"; "T:Reified.MessageFormatSpec"; "T:Reified.MessageKeyError"; "T:Reified.MessageFormatSpecError"; "M:Reified.MessageDescriptorModule.key"; "M:Reified.MessageDescriptorModule.arguments"; "M:Reified.MessageDescriptorModule.segments"; "M:Reified.MessageDescriptorModule.Advanced.create"; "M:Reified.MessageDescriptorModule.Advanced.tryCreate"; "M:Reified.MessageDescriptorModule.Advanced.ofSegments"; "M:Reified.MessageFormatSpecModule.descriptor"; "M:Reified.MessageFormatSpecModule.fallback"; "M:Reified.MessageFormatSpecModule.pluralArgument"; "M:Reified.MessageFormatSpecModule.Advanced.create"; "M:Reified.MessageFormatSpecModule.Advanced.tryCreate"]
            "Rendering", ["T:Reified.Renderer"; "T:Reified.MessageLookup"; "T:Reified.MessageRequest"; "T:Reified.MessageResolution"; "T:Reified.MessageResolver"; "T:Reified.ValueFormatRequest"; "P:Reified.RendererModule.english"; "M:Reified.RendererModule.ofLookup"; "M:Reified.RendererModule.ofResourceManager"; "M:Reified.RendererModule.ofResourceManagerWithCultures"; "M:Reified.RendererModule.ofCurrentCulture"; "M:Reified.RendererModule.context"; "M:Reified.RendererModule.attribute"; "M:Reified.RendererModule.unscoped"; "M:Reified.RendererModule.withValues"; "M:Reified.RendererModule.attributeName"; "M:Reified.RendererModule.fullMessage"; "M:Reified.RendererModule.Advanced.ofResolver"; "M:Reified.RendererModule.Advanced.withValueFormatting"; "M:Reified.RendererModule.Advanced.attributePath"; "M:Reified.RendererModule.Advanced.lookupCandidates"; "M:Reified.RendererModule.Advanced.messageRequests"; "M:Reified.RendererModule.Advanced.attributeCandidates"; "M:Reified.RendererModule.Advanced.format"]
            "Catalogue", ["P:Reified.Catalogue.keys"; "P:Reified.Catalogue.arguments"; "P:Reified.Catalogue.english"; "P:Reified.Catalogue.pluralArgument"]
            "Violations", ["M:Reified.ViolationModule.render"; "M:Reified.ViolationModule.message"; "M:Reified.ViolationModule.fullMessage"; "M:Reified.ViolationModule.renderWith"; "M:Reified.ViolationModule.toMessageTree"; "M:Reified.ViolationModule.children"; "M:Reified.ViolationModule.flatten"; "M:Reified.ViolationModule.tryExpectation"; "M:Reified.ViolationModule.tryActual"; "M:Reified.ViolationModule.tryDescription"; "M:Reified.ViolationModule.conjoin"; "M:Reified.ViolationModule.alternatives"]
            "Descriptions and values", ["M:Reified.ConstraintDescriptionModule.children"; "M:Reified.ConstraintDescriptionModule.atoms"; "M:Reified.ConstraintDescriptionModule.isOpaque"; "M:Reified.ConstraintAtomModule.key"; "M:Reified.ConstraintAtomModule.render"; "M:Reified.ConstraintAtomModule.arguments"; "M:Reified.ConstraintValueModule.tryCreate"; "M:Reified.ConstraintValueModule.render"]
        ]
        Alias = None
    }
    {
        ...
        SymbolIds = [
            ...
            "Builder", ["P:Reified.ResultDSL.result"]
        ]
        Alias = None
    }
    {
        ...
        SymbolIds = [
            "Error", ["T:Reified.ParseError"]
            "Functions", ["M:Reified.Parse.int"; "M:Reified.Parse.long"; "M:Reified.Parse.decimal"; "M:Reified.Parse.float"; "M:Reified.Parse.bool"; "M:Reified.Parse.guid"; "M:Reified.Parse.dateTime"; "M:Reified.Parse.dateTimeOffset"; "M:Reified.Parse.dateOnly"; "M:Reified.Parse.timeOnly"; "M:Reified.Parse.enum"; "M:Reified.Parse.optional"; "M:Reified.Parse.optionalOr"; "M:Reified.Parse.intOption"; "M:Reified.Parse.boolOption"; "M:Reified.Parse.decimalOption"; "M:Reified.Parse.guidOption"; "M:Reified.Parse.intOrDefault"; "M:Reified.Parse.boolOrDefault"; "M:Reified.Parse.decimalOrDefault"]
        ]
        Alias = None
    }
    {
