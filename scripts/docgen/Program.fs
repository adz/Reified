...
let pageSpecs = [
    {
        ...
        SymbolIds = [
            ...
            "Wire DTO attributes (read by schemagen at generation time)", ["T:Axial.Schema.Wire.WireSchemaAttribute"; "T:Axial.Schema.Wire.WireNameAttribute"; "T:Axial.Schema.Wire.WireUnionAttribute"; "T:Axial.Schema.Wire.PatternAttribute"; "T:Axial.Schema.Wire.MinAttribute"; "T:Axial.Schema.Wire.MaxAttribute"; "T:Axial.Schema.Wire.AtLeastAttribute"; "T:Axial.Schema.Wire.GreaterThanAttribute"; "T:Axial.Schema.Wire.AtMostAttribute"; "T:Axial.Schema.Wire.LessThanAttribute"; "T:Axial.Schema.Wire.MultipleOfAttribute"; "T:Axial.Schema.Wire.DistinctAttribute"; "T:Axial.Schema.Wire.EmailAttribute"; "T:Axial.Schema.Wire.DefaultAttribute"]
        ]
        Alias = None
    }
    {
