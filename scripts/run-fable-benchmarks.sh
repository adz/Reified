...
project_dir="$root_dir/benchmarks/Reified.Benchmarks.Fable"
node_out="$root_dir/artifacts/fable-benchmarks/node"
beam_out="$root_dir/artifacts/fable-benchmarks/beam"
mise_state_dir="/tmp/reified-mise-state"
mise_cache_dir="/tmp/reified-mise-cache"
...
beam_ebin="$beam_out/_build/default/lib/reified_benchmarks_fable/ebin"
rm -rf "$beam_ebin"
mkdir -p "$beam_ebin"
