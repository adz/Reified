      ...
      items: [
        { type: 'doc', id: 'reference/index', label: 'API Reference' },
        {
          ...
          items: [
            ...
            { type: 'doc', id: 'reference/fsflow/check', label: 'Check' },
            { type: 'doc', id: 'reference/fsflow/diagnostics', label: 'Diagnostics' },
            { type: 'doc', id: 'reference/fsflow/validation', label: 'Validation' },
            { type: 'doc', id: 'reference/fsflow/result', label: 'Result' },
            { type: 'doc', id: 'reference/fsflow/runtime', label: 'Runtime' },
            { type: 'doc', id: 'reference/fsflow/taskflow', label: 'TaskFlow' },
            { type: 'doc', id: 'reference/fsflow/taskflow-runtime', label: 'TaskFlow Runtime' },
            { type: 'doc', id: 'reference/fsflow/taskflow-spec', label: 'TaskFlowSpec' },
            { type: 'doc', id: 'reference/fsflow/coldtask', label: 'ColdTask' },
            { type: 'doc', id: 'reference/fsflow/capability', label: 'Capability' },
