...
open System.Text
open Axial.Schema
open Axial.Schema.Json.JsonRuntime

/// <summary>A compiled JSON codec for one schema-described model.</summary>
/// <remarks>
/// <para>
/// Compile once with <see cref="M:Axial.Schema.Json.Json.compile``1" /> and reuse the codec for every value. Compilation
...
module rec Json =
    ...
    /// <see cref="T:Axial.Schema.Json.JsonCodecException" /> during decoding.
    /// </para>
    /// </remarks>
    ...
    /// <exception cref="T:Axial.Schema.Json.JsonCodecException">Thrown when the JSON does not match the schema's wire shape.</exception>
