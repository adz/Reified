...
module Catalogue =
    ...
    let internal specOf (key: string) (arguments: Map<string, ConstraintValue>) =
        ...
        | None ->
            // Unreachable for Reified-produced identities; an enumeration test proves it. Degrading to the key
    ...
    /// <summary>Every message key Reified can produce, including the composition and joining entries.</summary>
