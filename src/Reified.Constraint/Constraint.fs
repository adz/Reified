...
module Constraint =
    ...
    /// </para>
    /// <para>
    /// The prose is still required, and remains the default English rendering. Reified supplies no key of its own
    ...
    /// <summary>Requires text to match Reified's pragmatic email shape, <c>^[^@]+@[^@]+$</c>.</summary>
