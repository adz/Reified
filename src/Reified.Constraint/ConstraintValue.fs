...
/// its own negation when it holds a signed zero. Both break the invariant that a <see cref="T:Reified.Constraint.Violation" />
...
/// <remarks>
/// <para>
/// A value is admitted only when the representation is lossless in the semantics Reified's runtime diagnostics and
