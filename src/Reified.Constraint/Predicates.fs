...
module internal Predicates =
    ...
    /// character a validator treats as whitespace is blank here too, so a string this rejects is one Reified
    ...
    /// through the wire check for Reified to reject with a proper diagnostic.
    /// </para>
    /// </remarks>
