...
See the [Reified.Data documentation](https://adz.github.io/Reified/data/) for tutorials, partial matching, case
matrices, JSON conversion, and the complete API reference.
