...
type ResponseSpec =
    {
        ...
        /// <summary>Media type of the response body; ignored when <see cref="F:Reified.Schema.Http.ResponseSpec.JsonSchema" /> is <c>None</c>.</summary>
        MediaType: string
    }
...
type EndpointSpec =
    { Method: string
      ...
      Tags: string list
      /// <summary>JSON Schema text for the request body, produced by <see cref="M:Reified.Schema.JsonSchemaModule.generate" />.</summary>
      RequestSchema: string option
      Responses: ResponseSpec list }

/// <summary>Builder functions for <see cref="T:Reified.Schema.Http.EndpointSpec" />.</summary>
/// <example>
/// <code>
/// let createSignup =
