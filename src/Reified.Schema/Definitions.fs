...
/// validation-facing requirements such as <see cref="P:Reified.Schema.Constraint.email" /> remain separate
/// constraint metadata.
/// </para>
/// </remarks>
[<Struct>]
...
/// <see cref="P:Reified.Schema.RefinedValueOps.Construct" />, while inspection interpreters such as validation of
/// existing models, codec encoding, JSON Schema, UI, and documentation generation need
/// <see cref="P:Reified.Schema.RefinedValueOps.Inspect" />. Enforcing the pairing here means no construction path can
...
/// <see cref="P:Reified.Schema.CollectionValueDefinition.AcceptItem" /> invokes
/// <see cref="M:Reified.Schema.ICollectionItemInterpreter.Item``1" /> with the original <c>'item</c> type argument, and
