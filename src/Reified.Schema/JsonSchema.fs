...
/// <remarks>
/// <para>
/// The generator is a pure interpreter over <see cref="T:Reified.Schema.Inspect" /> descriptions: it lowers shapes,
...
module JsonSchema =
    ...
    let private constraintKeywords shape (constraints: ConstraintDescription list) =
        ...
        let runtimeKeyword =
            ...
            | [] -> []
            | entries -> [ entries |> String.concat "," |> sprintf "\"x-reified-runtime-constraints\":[%s]" ]
