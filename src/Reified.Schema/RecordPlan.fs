...
/// <see cref="T:Reified.Schema.IRecordPlanCompiler`2" />. The value is intentionally opaque to <c>Reified.Schema</c>;
...
/// </summary>
/// <remarks>
/// The built <see cref="T:Reified.Schema.Schema`1" /> keeps this typed shape alongside its type-erased
