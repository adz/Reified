...
module LocalizationTests =
    ...
    module Resolvers =
        ...
        let ``messageRequests reports the owning catalogue's plural operand`` () =
            ...
            // The same generic path a foreign catalogue relies on, with no knowledge of it in Reified.Constraint.
            let translated =
    ...
    module Cultures =
        let private resources () =
            Resources.ResourceManager("Reified.Tests.Messages", Reflection.Assembly.GetExecutingAssembly())
