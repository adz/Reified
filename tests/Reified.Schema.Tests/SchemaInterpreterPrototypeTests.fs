...
/// emitter that started here has been promoted to the shipped <c>Reified.Schema.JsonSchema</c> module.
/// </summary>
...
module SchemaInterpreterPrototypeTests =
    ...
    let ``json schema generation lowers constraint metadata without running validation`` () =
        ...
        test <@ generated.Contains "\"tags\":{\"type\":\"array\",\"items\":{\"type\":\"object\",\"properties\":{\"label\":{\"type\":\"string\"}},\"required\":[\"label\"]},\"minItems\":1,\"x-reified-runtime-constraints\":[{\"rule\":\"constraint.uniqueness\"" @>
