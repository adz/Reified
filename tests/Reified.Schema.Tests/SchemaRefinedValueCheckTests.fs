...
module SchemaRefinedValueCheckTests =
    ...
    let ``constraints attached after refinement execute against the refined value`` () =
        ...
        test <@ Schema.parse schema (Reified.Data.Data.Text "ada@example.com") = Ok allowed @>
        test <@ Schema.parse schema (Reified.Data.Data.Text "grace@example.com") |> Result.isError @>
