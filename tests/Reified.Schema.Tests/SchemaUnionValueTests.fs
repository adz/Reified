...
module SchemaUnionValueTests =
    ...
    let ``union value schemas lower to json schema oneOf with const discriminators`` () =
        ...
        test <@ generated.Contains "{\"type\":\"object\",\"properties\":{\"type\":{\"const\":\"card\"},\"value\":{\"type\":\"object\",\"properties\":{\"number\":{\"type\":\"string\",\"pattern\":\"\\\\S\",\"x-reified-runtime-constraints\":[{\"rule\":\"constraint.presence.present\",\"description\":\"value must be present\"}]}},\"required\":[\"number\"]}},\"required\":[\"type\",\"value\"]}" @>
